...
<body>
    ...
    <main>
        <section class="title-container">
            ...
            <div class="search-container">
                <form action="" method="post">
                    <input type="text" name="busca" class="search-input" placeholder="Buscar Projeto" value="" />
        ...
        <section>
            ...
            $busca = $_POST['busca'] ?? '';
            if ($busca != '') {
                include("../controls/proj_search.php");
            } else {

                include_once('../controls/project_list.php');
            } ?>
        </section>
        <div class="btt">
            <br>
            <a href="./home"><button class="btt">Voltar</button></a>
            <a href="./cad_proj"><button class="btt"> Cadastrar</button></a>
            <a href="./project_arq"><button class="btt">Concluídos</button></a>
        </div>
        <?php
        mysqli_close($conn);
        ?>
