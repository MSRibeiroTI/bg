...
<body>
    ...
    <main>
        ...
        <section>
            ...
            $busca = $_POST['busca'] ?? '';
            if ($busca != '') {
                include("../controls/eng_search_inative.php");
            } else {

                include_once('../controls/eng_list_inactive.php');
            } ?>
        </section>
        <div class="btt">
            <br>
            <a href="./engenheiros"><button class="btt">Voltar</button></a>
