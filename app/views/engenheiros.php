...
<body>
    ...
    <main>
        ...
        <section>
            ...
            $busca = $_POST['busca'] ?? '';
            if ($busca != '') {
                include("../controls/eng_search.php");
            } else {

                include_once('../controls/eng_list.php');
            } ?>
        </section>
        <div class="btt">
            <br>
            <a href="./home"><button class="btt">Voltar</button></a>
            <a href="./cad_eng"><button class="btt"> Cadastrar</button></a>
            <a href="./eng_inactive"><button class="btt">Desativados</button></a>
        </div>
        <?php
        mysqli_close($conn);
        ?>
