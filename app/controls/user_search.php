...
$sql = "SELECT * FROM usuarios where nome like '%$busca%' AND ativo = '1'";
$resultado = mysqli_query($conn, $sql);
$total_linhas = mysqli_num_rows($resultado);
$sql = "SELECT * FROM usuarios where nome like '%$busca%' AND ativo = '1' order by nome ASC LIMIT $limit OFFSET $offset";
