...
$sql5 = "SELECT * FROM mensagens_clientes where status = '2' and id_user = $_SESSION[id_user]";
$resultado5 = mysqli_query($conn, $sql5);
$total_linhas = mysqli_num_rows($resultado5);
$sql = "SELECT * FROM mensagens_clientes where status = '2'  and id_user = $_SESSION[id_user] order by date DESC LIMIT $limit OFFSET $offset";
