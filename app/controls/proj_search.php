...
$sql = "SELECT * FROM projetos where name like '%$busca%'";
...
JOIN engenheiros on engenheiros.id_eng = projetos.id_eng where name like '%$busca%' order by name ASC LIMIT $limit OFFSET $offset";
    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_assoc($res)) : ?>
            <tr>
                ...
                <td>
                    <a href="../views/edit_user?id=<?php echo $row['id_proj'] ?>"><span title="Abrir"><button>Abrir</span></button></a>
                    <a onclick="return confirm('Deseja realmente arquivar esse projeto?')" href="../controls/arq_proj?id=<?php echo $row['id_proj'] ?>"><button>Arquivar</button></a>
                </td>
