<?php
include('../controls/deleteuser.php');
$todos = isset($_POST['listar']) ? $_POST['listar'] : '';
$page = (isset($_GET['page'])) ? $_GET['page'] : 1;
$limit = 10;
$offset = ($limit * $page) - $limit;

$sql5 = "SELECT * FROM usuarios WHERE ativo = '0'";
$resultado5 = mysqli_query($conn, $sql5);
$total_linhas = mysqli_num_rows($resultado5);
$sql = "SELECT * FROM usuarios WHERE ativo = '0' order by nome ASC LIMIT $limit OFFSET $offset";
    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_assoc($res)) : ?>
            <tr>
                ...
                <td>
                    <a href="../controls/undeleteuser?id=<?php echo $row['id_user'] ?>"><span title="Reativar"><button>Reativar</span></button></a>
                </td>
