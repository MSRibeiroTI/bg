...
$sql5 = "SELECT * FROM projetos where arquivo = 1";
...
JOIN engenheiros on engenheiros.id_eng = projetos.id_eng where arquivo = 1 order by id_proj ASC LIMIT $limit OFFSET $offset";
