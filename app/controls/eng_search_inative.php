...
$sql = "SELECT * FROM engenheiros where nome like '%$busca%' AND ativo = '0'";
$resultado = mysqli_query($conn, $sql);
$total_linhas = mysqli_num_rows($resultado);
$sql = "SELECT * FROM engenheiros where nome like '%$busca%' AND ativo = '0' order by nome ASC LIMIT $limit OFFSET $offset";
