...
$sql = "SELECT * FROM projetos where arquivo = 0 and name like '%$busca%'";
...
JOIN engenheiros on engenheiros.id_eng = projetos.id_eng where arquivo = 0 and name like '%$busca%' order by name ASC LIMIT $limit OFFSET $offset";
